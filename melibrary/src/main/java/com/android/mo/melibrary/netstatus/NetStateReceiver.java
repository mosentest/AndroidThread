...
package com.android.mo.melibrary.netstatus;
...
public class NetStateReceiver extends BroadcastReceiver {
    ...
    public final static String CUSTOM_ANDROID_NET_CHANGE_ACTION = "com.android.mo.melibrary.net.conn.CONNECTIVITY_CHANGE";
    ...
    public static void registerNetworkStateReceiver(Context mContext) {
        ...
        LocalBroadcastManager.getInstance(mContext.getApplicationContext()).registerReceiver(getReceiver(), filter);
    }
    ...
    public static void unRegisterNetworkStateReceiver(Context mContext) {
        if (mBroadcastReceiver != null) {
            try {
                LocalBroadcastManager.getInstance(mContext.getApplicationContext()).unregisterReceiver(mBroadcastReceiver);
            } catch (Exception e) {
            }
        }
